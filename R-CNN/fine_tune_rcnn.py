...
# left off
baseModel = MobileNetV2(weights="imagenet", include_top=False, #weights = imagenet
...
headModel = Dense(64, activation="relu")(headModel) #added
headModel = Dense(32, activation="relu")(headModel) #added
